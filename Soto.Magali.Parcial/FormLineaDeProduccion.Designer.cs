namespace Soto.Magali.Parcial
{
    partial class FormLineaDeProduccion
    {
        ...
        private void InitializeComponent()
        {
            ...
            buttonProducir.Location = new Point(276, 211);
            ...
            // buttonVerProductos
            // 
            buttonVerProductos.BackColor = Color.White;
            buttonVerProductos.FlatAppearance.BorderColor = Color.PaleVioletRed;
            buttonVerProductos.FlatAppearance.BorderSize = 2;
            buttonVerProductos.FlatStyle = FlatStyle.Flat;
            buttonVerProductos.Font = new Font("Sitka Text", 9F, FontStyle.Regular, GraphicsUnit.Point);
            buttonVerProductos.Location = new Point(276, 246);
            buttonVerProductos.Name = "buttonVerProductos";
            buttonVerProductos.Size = new Size(120, 29);
            buttonVerProductos.TabIndex = 17;
            buttonVerProductos.Text = "Ver productos";
            ...
            ControlBox = false;
            Controls.Add(buttonVerProductos);
